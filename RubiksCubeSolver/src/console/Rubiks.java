...
//		solve();
	...
	static void displayCube() {
		...
		System.out.println("" + left[0][0] + left[0][1] + left[0][2] + "  " + front[0][0] + front[0][1] + front[0][2]
				+ "  " + right[0][0] + right[0][1] + right[0][2]);
		System.out.println("" + left[1][0] + left[1][1] + left[1][2] + "  " + front[1][0] + front[1][1] + front[1][2]
				+ "  " + right[1][0] + right[1][1] + right[1][2]);
		System.out.println("" + left[2][0] + left[2][1] + left[2][2] + "  " + front[2][0] + front[2][1] + front[2][2]
	...
	static boolean oneSideSolved(char[][] side) {
		char color = side[0][0];
		for (int r = 0; r < 3; r++) {
			for (int c = 0; c < 3; c++) {
				if (side[r][c] != color) {
